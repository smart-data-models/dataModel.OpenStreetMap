...
Descrizione globale: **Una caratteristica naturale di OpenStreetMap contrassegnata con natural=*. Descrive caratteristiche geografiche come corpi idrici, boschi, cespuglieti, vette, spiagge, ecc.**
version: 0.0.1
<!-- /20-Description -->
<!-- 30-PropertiesList -->
...
<sup><sub>[*] Se non è presente un tipo in un attributo, è perché potrebbe avere diversi tipi o formati/pattern diversi</sub></sup>
...
- `elevation[number]`: Elevazione (ele) della caratteristica in metri sul livello del mare, tipicamente per le vette. Modello: [https://wiki.openstreetmap.org/wiki/Key:ele](https://wiki.openstreetmap.org/wiki/Key:ele)
- `id[*]`: Identificatore univoco dell'entità
- `leafCycle[string]`: Il ciclo delle foglie degli alberi o dei boschi. Modello: [https://wiki.openstreetmap.org/wiki/Key:leaf_cycle](https://wiki.openstreetmap.org/wiki/Key:leaf_cycle)
- `leafType[string]`: Il tipo di foglia degli alberi o dei boschi. Modello: [https://wiki.openstreetmap.org/wiki/Key:leaf_type](https://wiki.openstreetmap.org/wiki/Key:leaf_type)
- `location[*]`: Riferimento Geojson all'elemento. Può essere Point, LineString, Polygon, MultiPoint, MultiLineString o MultiPolygon
- `name[string]`: Il nome di questo elemento
- `naturalType[string]`: Il tag OSM natural che classifica la caratteristica geologica o fisica. Enum: 'water, wood, tree, scrub, heath, grassland, peak, ridge, bare_rock, sand, beach, coastline, spring, cave_entrance, wetland...'. Modello: [https://wiki.openstreetmap.org/wiki/Key:natural](https://wiki.openstreetmap.org/wiki/Key:natural)
...
- `source[string]`: Una sequenza di caratteri che fornisce la fonte originale dei dati dell'entità come URL. Consigliato sia il nome di dominio completamente qualificato del fornitore della fonte, o l'URL dell'oggetto sorgente
- `type[string]`: Tipo di entità NGSI. Deve essere OSMNatural
- `water[string]`: Tipo di corpo idrico se natural=water (ad esempio lago, serbatoio, fiume, stagno). Modello: [https://wiki.openstreetmap.org/wiki/Key:water](https://wiki.openstreetmap.org/wiki/Key:water)
- `wetland[string]`: Tipo di zona umida se natural=wetland (ad esempio palude, torbiera, acquitrino). Modello: [https://wiki.openstreetmap.org/wiki/Key:wetland](https://wiki.openstreetmap.org/wiki/Key:wetland)
<!-- /30-PropertiesList -->
...
## Esempi di payload
#### Esempio OSMNatural NGSI-v2 in formato chiave-valore
Ecco un esempio di OSMNatural in formato JSON come chiave-valore. È compatibile con NGSI-v2 quando si utilizza `options=keyValues` e restituisce i dati contestuali di un'entità individuale.
...
#### Esempio OSMNatural NGSI-v2 normalizzato
Ecco un esempio di OSMNatural in formato JSON normalizzato. È compatibile con NGSI-v2 quando non si utilizzano opzioni e restituisce i dati contestuali di un'entità individuale.
<details><summary><strong>mostra/nascondi esempio</strong></summary>
```json  
...
#### Esempio OSMNatural NGSI-LD in formato chiave-valore
Ecco un esempio di OSMNatural in formato JSON-LD come chiave-valore. È compatibile con NGSI-LD quando si utilizza `options=keyValues` e restituisce i dati contestuali di un'entità individuale.
<details><summary><strong>mostra/nascondi esempio</strong></summary>
```json  
...
#### Esempio OSMNatural NGSI-LD normalizzato
Ecco un esempio di OSMNatural in formato JSON-LD normalizzato. È compatibile con NGSI-LD quando non si utilizzano opzioni e restituisce i dati contestuali di un'entità individuale.
<details><summary><strong>mostra/nascondi esempio</strong></summary>
```json  
...
Consulta [FAQ 10](https://smartdatamodels.org/index.php/faqs/) per sapere come gestire le unità di misura delle grandezze
<!-- /95-Units -->
<!-- 97-LastFooter -->
---
