...
<!-- /15-License -->
<!-- 20-Description -->
Descrizione globale: **Una fermata, stazione, banchina o punto di salita/discesa dei trasporti pubblici da OpenStreetMap. Rappresenta nodi e aree in cui i passeggeri salgono o scendono dai servizi di trasporto pubblico, contrassegnati con public_transport=* o tag specifici per modalità di trasporto.**.
versione: 0.0.1
<!-- /20-Description -->
<!-- 30-PropertiesList -->
...
- `bench[boolean]`: Indica se è disponibile una panchina o un posto a sedere in questa fermata. Modello: [https://wiki.openstreetmap.org/wiki/Key:bench](https://wiki.openstreetmap.org/wiki/Key:bench)
- `bin[boolean]`: Indica se è presente un cestino dei rifiuti in questa fermata. Modello: [https://wiki.openstreetmap.org/wiki/Key:bin](https://wiki.openstreetmap.org/wiki/Key:bin)
...
- `network[string]`: Nome della rete di trasporto pubblico a cui appartiene questa fermata. Modello: [https://wiki.openstreetmap.org/wiki/Key:network](https://wiki.openstreetmap.org/wiki/Key:network)
- `openingHours[string]`: Orari di apertura della fermata o stazione nel formato OSM opening_hours. Modello: [https://wiki.openstreetmap.org/wiki/Key:opening_hours](https://wiki.openstreetmap.org/wiki/Key:opening_hours)
- `operator[string]`: Nome dell'operatore che gestisce i servizi in questa fermata. Modello: [https://wiki.openstreetmap.org/wiki/Key:operator](https://wiki.openstreetmap.org/wiki/Key:operator)
...
- `owner[array]`: Un elenco contenente una sequenza di caratteri in formato JSON che fa riferimento agli ID univoci del/dei proprietario/i
- `publicTransportType[string]`: Il valore del tag public_transport di OSM che indica il ruolo di questo elemento nella rete di trasporto pubblico. Enum: 'stop_position, platform, station, stop_area'. Modello: [https://wiki.openstreetmap.org/wiki/Key:public_transport](https://wiki.openstreetmap.org/wiki/Key:public_transport)
- `ref[string]`: Codice o numero di riferimento ufficiale della fermata utilizzato dall'operatore di trasporto. Modello: [https://wiki.openstreetmap.org/wiki/Key:ref](https://wiki.openstreetmap.org/wiki/Key:ref)
- `seeAlso[*]`: Elenco di URI che puntano a risorse aggiuntive su questo elemento
- `shelter[boolean]`: Indica se è disponibile una tettoia o riparo per le intemperie in questa fermata. Modello: [https://wiki.openstreetmap.org/wiki/Key:shelter](https://wiki.openstreetmap.org/wiki/Key:shelter)
- `source[string]`: Una sequenza di caratteri che fornisce la fonte originale dei dati dell'entità come URL. Si consiglia di utilizzare il nome di dominio completo del fornitore della fonte o l'URL dell'oggetto sorgente
- `tactilePaving[boolean]`: Indica se è presente una pavimentazione tattile per utenti ipovedenti. Modello: [https://wiki.openstreetmap.org/wiki/Key:tactile_paving](https://wiki.openstreetmap.org/wiki/Key:tactile_paving)
- `transportMode[array]`: Elenco delle modalità di trasporto servite in questa fermata. Modello: [https://wiki.openstreetmap.org/wiki/Public_transport](https://wiki.openstreetmap.org/wiki/Public_transport)
- `type[string]`: Tipo di entità NGSI. Deve essere OSMPublicTransportStop
- `wheelchair[string]`: Indica il livello di accessibilità con sedia a rotelle in questa fermata. Enum: 'yes, no, limited'. Modello: [https://wiki.openstreetmap.org/wiki/Key:wheelchair](https://wiki.openstreetmap.org/wiki/Key:wheelchair)
<!-- /30-PropertiesList -->
...
## Esempi di payload
#### Esempio di OSMPublicTransportStop NGSI-v2 in formato chiave-valore
Ecco un esempio di OSMPublicTransportStop in formato JSON come chiave-valore. È compatibile con NGSI-v2 quando si utilizza `options=keyValues` e restituisce i dati contestuali di un'entità individuale.
...
#### Esempio normalizzato di OSMPublicTransportStop NGSI-v2
Ecco un esempio di OSMPublicTransportStop in formato JSON normalizzato. È compatibile con NGSI-v2 quando non si utilizzano opzioni e restituisce i dati contestuali di un'entità individuale.
<details><summary><strong>mostra/nascondi esempio</strong></summary>
```json  
...
#### Esempio di OSMPublicTransportStop NGSI-LD in formato chiave-valore
Ecco un esempio di OSMPublicTransportStop in formato JSON-LD come chiave-valore. È compatibile con NGSI-LD quando si utilizza `options=keyValues` e restituisce i dati contestuali di un'entità individuale.
<details><summary><strong>mostra/nascondi esempio</strong></summary>
```json  
...
#### Esempio normalizzato di OSMPublicTransportStop NGSI-LD
Ecco un esempio di OSMPublicTransportStop in formato JSON-LD normalizzato. È compatibile con NGSI-LD quando non si utilizzano opzioni e restituisce i dati contestuali di un'entità individuale.
<details><summary><strong>mostra/nascondi esempio</strong></summary>
```json  
