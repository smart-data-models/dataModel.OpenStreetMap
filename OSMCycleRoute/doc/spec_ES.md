...
Descripción global: **Un elemento de infraestructura ciclista dedicado de OpenStreetMap. Representa caminos para bicicletas, carriles compartidos para bicicletas y rutas para bicicletas etiquetadas con highway=cycleway o cycleway=* en vías.**  
...
- `access[string]`: Restricción de acceso aplicable a los ciclistas en esta ruta. Modelo: [https://wiki.openstreetmap.org/wiki/Key:access](https://wiki.openstreetmap.org/wiki/Key:access)  
...
- `cyclewayType[string]`: Clasificación de la infraestructura ciclista. Enum:'carril, pista, opuesto, carril_opuesto, carril_compartido, sendero, separado, compartido'. Modelo: [https://wiki.openstreetmap.org/wiki/Key:cycleway](https://wiki.openstreetmap.org/wiki/Key:cycleway)  
...
- `lit[boolean]`: Indica si la ruta ciclista tiene iluminación en la calle. Modelo: [https://wiki.openstreetmap.org/wiki/Key:lit](https://wiki.openstreetmap.org/wiki/Key:lit)  
...
- `ncnRef[string]`: Número de referencia de la ruta de la Red Ciclista Nacional. Modelo: [https://wiki.openstreetmap.org/wiki/Key:ncn_ref](https://wiki.openstreetmap.org/wiki/Key:ncn_ref)  
- `oneway[boolean]`: Indica si la ruta ciclista es de un solo sentido para los ciclistas. Modelo: [https://wiki.openstreetmap.org/wiki/Key:oneway](https://wiki.openstreetmap.org/wiki/Key:oneway)  
- `operator[string]`: Nombre de la entidad responsable de mantener esta ruta ciclista. Modelo: [https://wiki.openstreetmap.org/wiki/Key:operator](https://wiki.openstreetmap.org/wiki/Key:operator)  
...
- `rcnRef[string]`: Número de referencia de la ruta de la Red Ciclista Regional. Modelo: [https://wiki.openstreetmap.org/wiki/Key:rcn_ref](https://wiki.openstreetmap.org/wiki/Key:rcn_ref)  
...
- `surface[string]`: Material de superficie física del camino para bicicletas. Modelo: [https://wiki.openstreetmap.org/wiki/Key:surface](https://wiki.openstreetmap.org/wiki/Key:surface)  
- `type[string]`: Tipo de entidad NGSI. Debe ser OSMCycleRoute   
- `widthMeters[number]`: Ancho del camino para bicicletas en metros. Modelo: [https://wiki.openstreetmap.org/wiki/Key:width](https://wiki.openstreetmap.org/wiki/Key:width)  
<!-- /30-PropertiesList -->  
...
Aquí hay un ejemplo de un OSMCycleRoute en formato JSON como clave-valor. Esto es compatible con NGSI-v2 cuando se utiliza `options=keyValues` y devuelve los datos de contexto de una entidad individual.  
...
Aquí hay un ejemplo de un OSMCycleRoute en formato JSON como normalizado. Esto es compatible con NGSI-v2 cuando no se utilizan opciones y devuelve los datos de contexto de una entidad individual.  
<details><summary><strong>mostrar/ocultar ejemplo</strong></summary>    
...
Aquí hay un ejemplo de un OSMCycleRoute en formato JSON-LD como clave-valor. Esto es compatible con NGSI-LD cuando se utiliza `options=keyValues` y devuelve los datos de contexto de una entidad individual.  
<details><summary><strong>mostrar/ocultar ejemplo</strong></summary>    
...
Aquí hay un ejemplo de un OSMCycleRoute en formato JSON-LD como normalizado. Esto es compatible con NGSI-LD cuando no se utilizan opciones y devuelve los datos de contexto de una entidad individual.  
<details><summary><strong>mostrar/ocultar ejemplo</strong></summary>    
