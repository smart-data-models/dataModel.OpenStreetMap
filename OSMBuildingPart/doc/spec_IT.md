...
Descrizione globale: **Una parte o sezione di un edificio da OpenStreetMap contrassegnata con building:part=*. Utilizzato per rappresentare edifici con altezze, forme di tetto o materiali diversi in sezioni diverse, abilitando la visualizzazione 3D degli edifici (standard Simple 3D Buildings).**  
...
#### Esempio OSMBuildingPart NGSI-v2 chiave-valore    
 
Ecco un esempio di OSMBuildingPart in formato JSON come chiave-valore. Questo è compatibile con NGSI-v2 quando si utilizza `options=keyValues` e restituisce i dati di contesto di un'entità individuale.  
...
#### Esempio OSMBuildingPart NGSI-v2 normalizzato    
 
Ecco un esempio di OSMBuildingPart in formato JSON come normalizzato. Questo è compatibile con NGSI-v2 quando non si utilizzano opzioni e restituisce i dati di contesto di un'entità individuale.  
<details><summary><strong>mostra/nascondi esempio</strong></summary>    
...
#### Esempio OSMBuildingPart NGSI-LD chiave-valore    
 
Ecco un esempio di OSMBuildingPart in formato JSON-LD come chiave-valore. Questo è compatibile con NGSI-LD quando si utilizza `options=keyValues` e restituisce i dati di contesto di un'entità individuale.  
<details><summary><strong>mostra/nascondi esempio</strong></summary>    
...
#### Esempio OSMBuildingPart NGSI-LD normalizzato    
 
Ecco un esempio di OSMBuildingPart in formato JSON-LD come normalizzato. Questo è compatibile con NGSI-LD quando non si utilizzano opzioni e restituisce i dati di contesto di un'entità individuale.  
<details><summary><strong>mostra/nascondi esempio</strong></summary>    
