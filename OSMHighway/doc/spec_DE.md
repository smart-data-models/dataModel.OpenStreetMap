...
<!-- /15-License -->  
<!-- 20-Description -->  
Globale Beschreibung: **Ein Straßen- oder Wegeelement aus OpenStreetMap, das mit dem Schlüssel "highway" gekennzeichnet ist. Repräsentiert alle Arten von Straßen, von Autobahnen bis zu Fußwegen, wie in der OSM-Highway-Taxonomie definiert.**  
version: 0.0.1  
<!-- /20-Description -->  
<!-- 30-PropertiesList -->  
...
Hier ist ein Beispiel eines OSMHighway im JSON-Format als Schlüssel-Werte. Dies ist kompatibel mit NGSI-v2, wenn `options=keyValues` verwendet wird und die Kontextdaten einer einzelnen Entität zurückgibt.  
...
Hier ist ein Beispiel eines OSMHighway im JSON-Format als normalisiert. Dies ist kompatibel mit NGSI-v2, wenn keine Optionen verwendet werden und die Kontextdaten einer einzelnen Entität zurückgibt.  
<details><summary><strong>Beispiel anzeigen/ausblenden</strong></summary>    
```json  
...
Hier ist ein Beispiel eines OSMHighway im JSON-LD-Format als Schlüssel-Werte. Dies ist kompatibel mit NGSI-LD, wenn `options=keyValues` verwendet wird und die Kontextdaten einer einzelnen Entität zurückgibt.  
<details><summary><strong>Beispiel anzeigen/ausblenden</strong></summary>    
```json  
...
Hier ist ein Beispiel eines OSMHighway im JSON-LD-Format als normalisiert. Dies ist kompatibel mit NGSI-LD, wenn keine Optionen verwendet werden und die Kontextdaten einer einzelnen Entität zurückgibt.  
<details><summary><strong>Beispiel anzeigen/ausblenden</strong></summary>    
```json  
