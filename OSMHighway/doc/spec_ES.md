...
<!-- /15-License -->  
<!-- 20-Description -->  
Descripción global: **Un elemento de carretera o camino de OpenStreetMap etiquetado con la clave highway. Representa todos los tipos de carreteras, desde autopistas hasta senderos, según lo definido por la taxonomía de carreteras de OSM.**  
versión: 0.0.1  
<!-- /20-Description -->  
<!-- 30-PropertiesList -->  
...
Aquí hay un ejemplo de una OSMHighway en formato JSON como key-values. Esto es compatible con NGSI-v2 cuando se usa `options=keyValues` y devuelve los datos de contexto de una entidad individual.  
...
Aquí hay un ejemplo de una OSMHighway en formato JSON como normalizado. Esto es compatible con NGSI-v2 cuando no se usan opciones y devuelve los datos de contexto de una entidad individual.  
<details><summary><strong>mostrar/ocultar ejemplo</strong></summary>    
```json  
...
Aquí hay un ejemplo de una OSMHighway en formato JSON-LD como key-values. Esto es compatible con NGSI-LD cuando se usa `options=keyValues` y devuelve los datos de contexto de una entidad individual.  
<details><summary><strong>mostrar/ocultar ejemplo</strong></summary>    
```json  
...
Aquí hay un ejemplo de una OSMHighway en formato JSON-LD como normalizado. Esto es compatible con NGSI-LD cuando no se usan opciones y devuelve los datos de contexto de una entidad individual.  
<details><summary><strong>mostrar/ocultar ejemplo</strong></summary>    
```json  
