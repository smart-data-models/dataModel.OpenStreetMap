...
Descripción global: **Una vía o elemento de infraestructura ferroviaria de OpenStreetMap etiquetada con la clave de ferrocarril. Cubre todos los tipos de infraestructura ferroviaria, desde ferrocarriles pesados hasta tranvías, metros y funiculares.**  
...
- `areaServed[string]`: El área geográfica donde se ofrece un servicio o artículo  . Modelo: [https://schema.org/Text](https://schema.org/Text)  
- `bridge[boolean]`: Indica si este segmento de ferrocarril pasa por un puente  . Modelo: [https://wiki.openstreetmap.org/wiki/Key:bridge](https://wiki.openstreetmap.org/wiki/Key:bridge)  
...
- `electrified[string]`: Método de electrificación del ferrocarril  . Modelo: [https://wiki.openstreetmap.org/wiki/Key:electrified](https://wiki.openstreetmap.org/wiki/Key:electrified)  
- `frequency[number]`: Frecuencia eléctrica de la corriente de tracción en Hertz  . Modelo: [https://wiki.openstreetmap.org/wiki/Key:frequency](https://wiki.openstreetmap.org/wiki/Key:frequency)  
- `gauge[number]`: Ancho de vía en milímetros (distancia entre los dos rieles)  . Modelo: [https://wiki.openstreetmap.org/wiki/Key:gauge](https://wiki.openstreetmap.org/wiki/Key:gauge)  
- `id[*]`: Identificador único de la entidad   
- `layer[number]`: Capa vertical relativa a otras características en la misma ubicación  . Modelo: [https://wiki.openstreetmap.org/wiki/Key:layer](https://wiki.openstreetmap.org/wiki/Key:layer)  
- `location[*]`: Referencia Geojson al elemento. Puede ser Punto, LineString, Polígono, MultiPunto, MultiLineString o MultiPolígono   
- `maxSpeed[number]`: Velocidad máxima permitida en esta vía en kilómetros por hora  . Modelo: [https://wiki.openstreetmap.org/wiki/Key:maxspeed](https://wiki.openstreetmap.org/wiki/Key:maxspeed)  
- `name[string]`: El nombre de este elemento   
- `operator[string]`: Nombre de la empresa o operador ferroviario  . Modelo: [https://wiki.openstreetmap.org/wiki/Key:operator](https://wiki.openstreetmap.org/wiki/Key:operator)  
- `osmId[number]`: Identificador entero del elemento original de OpenStreetMap  . Modelo: [https://wiki.openstreetmap.org/wiki/Elements](https://wiki.openstreetmap.org/wiki/Elements)  
...
- `railwayType[string]`: El valor de la etiqueta de ferrocarril de OSM que clasifica el tipo de infraestructura ferroviaria. Enum:'rail, subway, tram, light_rail, narrow_gauge, monorail, funicular, miniature, preserved, disused, abandoned, construction, proposed'  . Modelo: [https://wiki.openstreetmap.org/wiki/Key:railway](https://wiki.openstreetmap.org/wiki/Key:railway)  
- `ref[string]`: Número de referencia o código de línea oficial  . Modelo: [https://wiki.openstreetmap.org/wiki/Key:ref](https://wiki.openstreetmap.org/wiki/Key:ref)  
- `seeAlso[*]`: Lista de URIs que apuntan a recursos adicionales sobre este elemento.   
- `service[string]`: Tipo de vía de servicio, si no es parte de la línea principal de funcionamiento  . Modelo: [https://wiki.openstreetmap.org/wiki/Key:service](https://wiki.openstreetmap.org/wiki/Key:service)  
...
- `tracks[number]`: Número de vías paralelas  . Modelo: [https://wiki.openstreetmap.org/wiki/Key:tracks](https://wiki.openstreetmap.org/wiki/Key:tracks)  
- `tunnel[boolean]`: Indica si este segmento de ferrocarril pasa por un túnel  . Modelo: [https://wiki.openstreetmap.org/wiki/Key:tunnel](https://wiki.openstreetmap.org/wiki/Key:tunnel)  
- `type[string]`: Tipo de entidad NGSI. Debe ser OSMRailway   
- `usage[string]`: Uso previsto de la línea ferroviaria  . Modelo: [https://wiki.openstreetmap.org/wiki/Key:usage](https://wiki.openstreetmap.org/wiki/Key:usage)  
- `voltage[number]`: Voltaje eléctrico utilizado para tracción en Volts  . Modelo: [https://wiki.openstreetmap.org/wiki/Key:voltage](https://wiki.openstreetmap.org/wiki/Key:voltage)  
<!-- /30-PropertiesList -->  
...
#### Ejemplo de OSMRailway NGSI-v2 clave-valor    
 
Aquí hay un ejemplo de un OSMRailway en formato JSON como clave-valor. Esto es compatible con NGSI-v2 cuando se utiliza `options=keyValues` y devuelve los datos de contexto de una entidad individual.  
...
Aquí hay un ejemplo de un OSMRailway en formato JSON como normalizado. Esto es compatible con NGSI-v2 cuando no se utilizan opciones y devuelve los datos de contexto de una entidad individual.  
<details><summary><strong>mostrar/ocultar ejemplo</strong></summary>    
...
#### Ejemplo de OSMRailway NGSI-LD clave-valor    
 
Aquí hay un ejemplo de un OSMRailway en formato JSON-LD como clave-valor. Esto es compatible con NGSI-LD cuando se utiliza `options=keyValues` y devuelve los datos de contexto de una entidad individual.  
<details><summary><strong>mostrar/ocultar ejemplo</strong></summary>    
...
Aquí hay un ejemplo de un OSMRailway en formato JSON-LD como normalizado. Esto es compatible con NGSI-LD cuando no se utilizan opciones y devuelve los datos de contexto de una entidad individual.  
<details><summary><strong>mostrar/ocultar ejemplo</strong></summary>    
