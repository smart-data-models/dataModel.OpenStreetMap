...
Descrizione globale: **Un luogo per il tempo libero, gli sport o il divertimento da OpenStreetMap contrassegnato con leisure=*. Comprende parchi, campi da gioco, piscine, stadi, ecc.**  
...
- `access[string]`: Restrizioni di accesso  . Modello: [https://wiki.openstreetmap.org/wiki/Key:access](https://wiki.openstreetmap.org/wiki/Key:access) 
- `address[object]`: L'indirizzo postale  . Modello: [https://schema.org/address](https://schema.org/address) 
	...
	- `postOfficeBoxNumber[string]`: Il numero della casella postale per gli indirizzi PO box. Ad esempio, 03578  . Modello: [https://schema.org/postOfficeBoxNumber](https://schema.org/postOfficeBoxNumber)  
...
- `fee[boolean]`: Indica se è richiesto un biglietto d'ingresso o un contributo per l'uso  . Modello: [https://wiki.openstreetmap.org/wiki/Key:fee](https://wiki.openstreetmap.org/wiki/Key:fee) 
- `id[*]`: Identificatore univoco dell'entità   
- `leisureType[string]`: Il tag di svago OSM che classifica la struttura. Enum:'parco, campo, piscina, centro sportivo, stadio, parco giochi, giardino, riserva naturale, marina...'  . Modello: [https://wiki.openstreetmap.org/wiki/Key:leisure](https://wiki.openstreetmap.org/wiki/Key:leisure) 
- `lit[boolean]`: Indica se la struttura è illuminata  . Modello: [https://wiki.openstreetmap.org/wiki/Key:lit](https://wiki.openstreetmap.org/wiki/Key:lit) 
...
- `openingHours[string]`: Orari di apertura della struttura   
- `operator[string]`: Operatore o entità di gestione   
- `osmId[number]`: Timestamp dell'ultima modifica   
- `osmLastModified[date-time]`: Il tipo dell'elemento OSM originale   
- `osmType[string]`: Una lista contenente una sequenza di caratteri JSON che fa riferimento agli ID univoci dei proprietari   
- `owner[array]`: Elenco di URI che puntano a risorse aggiuntive   
- `seeAlso[*]`: Una sequenza di caratteri che fornisce la fonte originale dei dati dell'entità come URL. Si consiglia di utilizzare il nome di dominio completamente qualificato del fornitore di origine o l'URL dell'oggetto di origine   
- `source[string]`: Lo sport specifico giocato qui (ad esempio calcio, tennis, basket)  . Modello: [https://wiki.openstreetmap.org/wiki/Key:sport](https://wiki.openstreetmap.org/wiki/Key:sport) 
- `sport[string]`: La superficie fisica del campo o della pista  . Modello: [https://wiki.openstreetmap.org/wiki/Key:surface](https://wiki.openstreetmap.org/wiki/Key:surface) 
- `surface[string]`: Tipo di entità NGSI. Deve essere OSMLeisure   
- `type[string]`: Accessibilità per disabili   
- `wheelchair[string]`: Accessibilità per disabili 
<!-- /30-PropertiesList -->  
...
#### Esempio OSMLeisure NGSI-v2 chiave-valore    
 
Ecco un esempio di OSMLeisure in formato JSON come chiave-valore. Questo è compatibile con NGSI-v2 quando si utilizza `options=keyValues` e restituisce i dati di contesto di un'entità individuale.  
...
#### Esempio OSMLeisure NGSI-v2 normalizzato    
 
Ecco un esempio di OSMLeisure in formato JSON come normalizzato. Questo è compatibile con NGSI-v2 quando non si utilizzano opzioni e restituisce i dati di contesto di un'entità individuale.  
<details><summary><strong>mostra/nascondi esempio</strong></summary>    
...
#### Esempio OSMLeisure NGSI-LD chiave-valore    
 
Ecco un esempio di OSMLeisure in formato JSON-LD come chiave-valore. Questo è compatibile con NGSI-LD quando si utilizza `options=keyValues` e restituisce i dati di contesto di un'entità individuale.  
<details><summary><strong>mostra/nascondi esempio</strong></summary>    
...
#### Esempio OSMLeisure NGSI-LD normalizzato    
 
Ecco un esempio di OSMLeisure in formato JSON-LD come normalizzato. Questo è compatibile con NGSI-LD quando non si utilizzano opzioni e restituisce i dati di contesto di un'entità individuale.  
<details><summary><strong>mostra/nascondi esempio</strong></summary>    
